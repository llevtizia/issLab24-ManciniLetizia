...
public static final String host    = "130.136.113.239"; //130.136.113.239
...
public void configureTheSystem()  {
    ...
    ProducerUsingConnection producer1 = new ProducerUsingConnection("letizia", host, port,protocol );
