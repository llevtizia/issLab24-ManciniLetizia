...
public abstract class ActorBasic24 implements IActor24 {
    protected BlockingQueue<IApplMessage> msgQueue     = new LinkedBlockingDeque<>(); // blocking
    ...
    public ActorBasic24(String name, ActorContext24 ctx ){ 
        ...
        this.ctx     = ctx;
        ctx.addActor(this);
        autoStartMsg = CommUtils.buildDispatch(name, "cmd", "start", name); // messaggio che invia a se stesso
    }
    ...
    protected void sendMsg( IApplMessage msg, ActorContext24 ctx  )   {
        try { 
            ...
            if (dest != null) {
            	...
            	// se non c'è nel contesto devo sperare sia esterno
