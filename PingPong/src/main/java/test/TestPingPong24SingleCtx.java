	...
	Thread th = new Thread(){
		public void run(){
			try {
				...
				Process p = Runtime.getRuntime().exec("./gradlew.bat runAll"); // per attivare il sistema (processo p)
				showOutput(p,ColorsOut.BLACK); // show output perché altrimenti non vedrei l'output di p
			} catch ( Exception e) {
